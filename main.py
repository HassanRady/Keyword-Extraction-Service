...
consumer_conf = {
    ...
    "group.id": settings.KAFKA_KEYWORDS_CONSUMER_GROUP,
...
def consume_produce_loop(consumer: Consumer, consumer_topics: Any, produce_topic: str):
    try:
...
if __name__ == "__main__":
    consume_produce_loop(
        consumer, [settings.KAFKA_STREAM_TEXT_TOPIC], settings.KAFKA_KEYWORDS_TOPIC
    )
